...
class Subscription_tier(IdMixin, AuditMixin, OperatorMixin, DurationMixin, db.Model):
    ...
    base_price = db.Column(db.Numeric(10, 2), nullable=True) # For Fixed and Flat strategies
    price_per_tier = db.Column(db.Numeric(10, 2), nullable=True) # For Pick and Fill strategies
    def __repr__(self):
